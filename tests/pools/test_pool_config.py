...
from mint.pools.pool_config import PoolWalletConfig
from mint.util.config import load_config, save_config, create_default_mint_config
...
def test_pool_config():
    ...
    create_default_mint_config(test_root, ["config.yaml"])
