...
from mint.types.blockchain_format.program import Program, SerializedProgram

wallet_program_files = set(
    [
        "mint/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "mint/wallet/puzzles/cc.clvm",
        "mint/wallet/puzzles/chialisp_deserialisation.clvm",
        "mint/wallet/puzzles/rom_bootstrap_generator.clvm",
        "mint/wallet/puzzles/generator_for_single_coin.clvm",
        "mint/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "mint/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "mint/wallet/puzzles/lock.inner.puzzle.clvm",
        "mint/wallet/puzzles/p2_conditions.clvm",
        "mint/wallet/puzzles/p2_delegated_conditions.clvm",
        "mint/wallet/puzzles/p2_delegated_puzzle.clvm",
        "mint/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "mint/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "mint/wallet/puzzles/p2_puzzle_hash.clvm",
        "mint/wallet/puzzles/rl_aggregation.clvm",
        "mint/wallet/puzzles/rl.clvm",
        "mint/wallet/puzzles/sha256tree_module.clvm",
        "mint/wallet/puzzles/singleton_top_layer.clvm",
        "mint/wallet/puzzles/did_innerpuz.clvm",
        "mint/wallet/puzzles/decompress_puzzle.clvm",
        "mint/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "mint/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "mint/wallet/puzzles/block_program_zero.clvm",
        "mint/wallet/puzzles/test_generator_deserialize.clvm",
        "mint/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "mint/wallet/puzzles/p2_singleton.clvm",
        "mint/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "mint/wallet/puzzles/pool_member_innerpuz.clvm",
        "mint/wallet/puzzles/singleton_launcher.clvm",
        "mint/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["mint/wallet/puzzles/create-lock-puzzlehash.clvm", "mint/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "mint/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to mint/wallet/puzzles, but not added to `wallet_program_files`
        """
