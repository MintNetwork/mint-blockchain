...
required to run a [Timelord](https://github.com/MintNetwork/mint-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/MintNetwork/mint-blockchain/blob/main/install-timelord.sh)
