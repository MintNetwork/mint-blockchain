...
from mint.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from mint.harvester.harvester import Harvester
from mint.plotting.util import PlotInfo, parse_plot_info
from mint.protocols import harvester_protocol
from mint.protocols.farmer_protocol import FarmingInfo
from mint.protocols.harvester_protocol import Plot
from mint.protocols.protocol_message_types import ProtocolMessageTypes
from mint.server.outbound_message import make_msg
...
from mint.util.api_decorators import api_request, peer_required
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSMintConnection
    ):
        """
