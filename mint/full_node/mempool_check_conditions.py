...
from mint.full_node.generator import create_generator_args, setup_generator_args
from mint.types.blockchain_format.coin import Coin
from mint.types.blockchain_format.program import NIL
...
from mint.util.clvm import int_from_bytes, int_to_bytes
...
from mint.util.ints import uint32, uint64, uint16
from mint.wallet.puzzles.generator_loader import GENERATOR_FOR_SINGLE_COIN_MOD
...
def parse_aggsig(args: SExp) -> List[bytes]:
    ...
    # just like as_atom_list() (see mint/types/blockchain_format/program.py)
