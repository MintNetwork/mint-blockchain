...
from mint.types.blockchain_format.reward_chain_block import RewardChainBlock, RewardChainBlockUnfinished
...
def create_foliage(
    ...
    extension_data: bytes32 = random.randint(1, 100000000).to_bytes(32, "big")
