...
from mint.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "59222"
            testnet_introducer = "beta1_introducer.mintnet.work"
            testnet_dns_introducer = "dns-introducer-testnet7.mintnet.work"
            testnet = "testnet7"
            ...
            mainnet_port = "29222"
            mainnet_introducer = "introducer.mintnet.work"
            mainnet_dns_introducer = "dns-introducer.mintnet.work"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running mint services for changes to take effect")
