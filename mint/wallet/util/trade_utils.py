...
from mint.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "mint" in cc_discrepancies:
                    cc_discrepancies["mint"] = cc_discrepancies["mint"] + diff
                else:
                    cc_discrepancies["mint"] = diff
