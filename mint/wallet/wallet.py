...
from mint.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    DEFAULT_HIDDEN_PUZZLE_HASH,
    calculate_synthetic_secret_key,
    puzzle_for_pk,
    solution_for_conditions,
)
from mint.wallet.puzzles.puzzle_utils import (
...
from mint.wallet.secret_key_store import SecretKeyStore
from mint.wallet.sign_coin_spends import sign_coin_spends
...
class Wallet:
    ...
    async def create_spend_bundle_relative_mint(self, mint_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if mint_amount < 0:
            utxos = await self.select_coins(abs(mint_amount), exclude)
        else:
        ...
        mint_amount = spend_value + mint_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": mint_amount}]
